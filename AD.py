...
def anomaly_detector():
    ...
    while True:
        ...
        data = v1.ngsi_get_historical('urn:ngsi-ld:sEMG:EMG1001',window_length,attribute='data')
        ...
        resp = v1.ngsi_patch(payload_raw,"urn:ngsi-ld:EmgFrequencyDomainFeatures:002")
